...
export default function NotFoundPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full backdrop-blur-sm bg-white/70 rounded-2xl shadow-xl overflow-hidden ">
        <div className="bg-gradient-to-r from-violet/90 to-indigo/80 p-8 flex flex-col items-center">
        ...
        <div className="p-8 text-center bg-white">
          ...
          <div className="flex justify-center">
            <Link 
              href="/" 
              className="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-gradient-to-r from-violet to-indigo p-px font-medium text-indigo-50 shadow-md transition-all duration-300 hover:shadow-lg hover:scale-105"
            >

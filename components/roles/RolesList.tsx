...
export default function RolesList({ roles }: RolesListProps) {
  ...
  return (
    <>
              ...
              <div className="overflow-y-auto h-full">
                <table className='w-full'>
                  <thead className='bg-gray text-white sticky top-0 z-10'>
                    <tr>
                      <th className='w-1/12 px-4 py-2 text-left text-sm font-semibold text-gray-700'><strong>#</strong></th>
                      <th className='w-1/6 px-4 py-2 text-left text-sm font-semibold text-gray-700'>JobRole</th>
                      <th className='w-1/6 px-4 py-2 text-left text-sm font-semibold text-gray-700'>Country</th>
                      <th className='w-1/6 px-4 py-2 text-left text-sm font-semibold text-gray-700'>Center Cost</th>
                      <th className='w-1/6 px-4 py-2 text-left text-sm font-semibold text-gray-700'>Cph Code</th>
                      <th className='w-1/6 px-4 py-2 text-left text-sm font-semibold text-gray-700'>Cph</th>
                      <th className='px-4 py-2 text-right ml-4 text-sm font-semibold text-gray-700'>Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {roles.map((role, index) => (
                      <tr key={role.id} className='border-b last:border-none border-gray/20'>
                        <td className='px-4 py-2 text-left text-sm font-semibold text-gray-700'>{index + 1}</td>
                        <td className='px-4 py-2 text-left text-sm font-semibold text-gray-700'>{role.jobRole}</td>
                        <td className='px-4 py-2 text-left text-sm font-semibold text-gray-700'>{role.country}</td>
                        <td className='px-4 py-2 text-left text-sm font-semibold text-gray-700'>{role.cc}</td>
                        <td className='px-4 py-2 text-left text-sm font-semibold text-gray-700'>{role.cphCode}</td>
                        <td className='px-4 py-2 text-left text-sm font-semibold text-gray-700'>{role.cph}</td>
      ...
      {isModalOpenDetail && <ModalRolesDetail roles={roles} onClose={handleCloseModalDetail} selectedRoleId={selectedRoleId}/>}
